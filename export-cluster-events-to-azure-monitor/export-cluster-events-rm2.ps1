...
# $watermark_table = "watermarkadblogs"
...
$DATABRICKS_TOKEN = "dapizzz" 
# Your Storage connection string 
$storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=wwww;AccountKey=kkkkkkintSuffix=core.windows.net"
############################
...
Write-Host "Starting at time watermark $($start_time)"
